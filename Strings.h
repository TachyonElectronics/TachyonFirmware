...
const PROGMEM char* const SettingsLabels[] = {Str_ExitSettings, Str_ManagePresets, Str_SetTime,Str_UISetup,Str_ReloadSetup,Str_SetDefaultBrightness,Str_NextPage};
...
const PROGMEM char* const Settings2Labels[] = {Str_Back, Str_BatterySetup, Str_CountDir,};
